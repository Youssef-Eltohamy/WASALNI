...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CategoriesLoading value)?  loading,TResult Function( CategoriesLoaded value)?  loaded,TResult Function( CategoriesNoConnection value)?  noConnection,TResult Function( CategoriesError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
case CategoriesLoading() when loading != null:
return loading(_that);case CategoriesLoaded() when loaded != null:
return loaded(_that);case CategoriesNoConnection() when noConnection != null:
return noConnection(_that);case CategoriesError() when error != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CategoriesLoading value)  loading,required TResult Function( CategoriesLoaded value)  loaded,required TResult Function( CategoriesNoConnection value)  noConnection,required TResult Function( CategoriesError value)  error,}){
final _that = this;
switch (_that) {
case CategoriesLoading():
return loading(_that);case CategoriesLoaded():
return loaded(_that);case CategoriesNoConnection():
return noConnection(_that);case CategoriesError():
return error(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CategoriesLoading value)?  loading,TResult? Function( CategoriesLoaded value)?  loaded,TResult? Function( CategoriesNoConnection value)?  noConnection,TResult? Function( CategoriesError value)?  error,}){
final _that = this;
switch (_that) {
case CategoriesLoading() when loading != null:
return loading(_that);case CategoriesLoaded() when loaded != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<Category> categories)?  loaded,TResult Function()?  noConnection,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CategoriesLoading() when loading != null:
return loading();case CategoriesLoaded() when loaded != null:
return loaded(_that.categories);case CategoriesNoConnection() when noConnection != null:
return noConnection();case CategoriesError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<Category> categories)  loaded,required TResult Function()  noConnection,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case CategoriesLoading():
return loading();case CategoriesLoaded():
return loaded(_that.categories);case CategoriesNoConnection():
return noConnection();case CategoriesError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<Category> categories)?  loaded,TResult? Function()?  noConnection,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case CategoriesLoading() when loading != null:
return loading();case CategoriesLoaded() when loaded != null:
return loaded(_that.categories);case CategoriesNoConnection() when noConnection != null:
...
class CategoriesNoConnection implements CategoriesState {
  const CategoriesNoConnection();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoriesNoConnection);
}
...
@override
String toString() {
  return 'CategoriesState.noConnection()';
}
